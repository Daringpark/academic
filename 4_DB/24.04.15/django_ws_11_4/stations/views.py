...
from .serializers import LocationSerializer, StationListSerializer, StationSerializer, CarSerializer, CarUpdateSeriailizer
...
def car_detail(request, car_pk):
    ...
    if request.method == "GET":
        ...
        serializer = CarUpdateSeriailizer(data = request.data)
        if serializer.is_valid(raise_exception= True):
            serializer.save()
            return Response(serializer.data)
